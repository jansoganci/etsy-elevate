      ...
      <div className="container px-4 md:px-6 relative">
        <div className="flex flex-col items-center justify-center space-y-6 text-center max-w-3xl mx-auto">
          ...
          <div className="w-full max-w-sm">
            <Button size="lg" className="w-full text-md h-12 group shadow-lg hover:shadow-xl transition-all duration-300 bg-primary">
          ...
          <div className="flex items-center justify-center gap-2 mt-8">
            <div className="flex -space-x-2">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="w-8 h-8 rounded-full bg-background shadow-sm border-2 border-background flex items-center justify-center text-xs font-medium overflow-hidden"
                >
                  <img
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full max-w-2xl mt-4">
            {['Time Saved', 'Listings Created', 'Revenue Generated', 'Happy Sellers'].map((stat, i) => (
              <div key={i} className="bg-background rounded-lg p-3 shadow-sm hover:shadow-md transition-all">
