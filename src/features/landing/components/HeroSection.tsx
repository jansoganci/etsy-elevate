      ...
      <div className="container px-4 md:px-6 relative">
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
          <div className="flex flex-col justify-center space-y-4">
            <div className="inline-flex items-center space-x-2 bg-primary/10 text-primary px-3 py-1 rounded-full text-sm font-medium mb-2 animate-fade-in hover:bg-primary/20 transition-colors w-fit">
              <Sparkles size={16} />
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              <Button size="lg" className="mt-4 group transition-all duration-300 hover:shadow-md">
                Create Your First Listing Free
                <ArrowRight className="ml-2 group-hover:translate-x-1 transition-transform" />
              </Button>
              <Button variant="outline" size="lg" className="mt-4 hover:bg-background/80">
                See How It Works
              </Button>
            </div>
