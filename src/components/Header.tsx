...
const Header = () => {
  ...
  return (
    <header className="h-16 bg-background/80 backdrop-blur-sm border-b border-border fixed top-0 right-0 left-0 z-50 header-shadow flex items-center justify-between px-6">
